...
function map_copy_run_special_garner2( map_copy ) 
	...
	if Every_5_minute == 8 then -- ºÚÁú½ÇÉ«
		...
		DealAllActivePlayerInMap(map_copy,"CheckTeamers")
	end
end
--Ã¿5ÃëÖ´ÐÐÒ»´ÎµÄ
...
--	SystemNotice(role,How_Many_Active)
	...
	--	local message = "½ñÌìµÄÂÒ¶·¹²´æ»îÁË"..How_Many_Active .. "Î»Íæ¼Ò,ËûÃÇÃ¿ÈË½«»ñµÃ"..Money_Garner2 .."µÄ½ðÇ®"
	--	SystemNotice(role,How_Many_Active)
		return
	end
	...
	if How_Many_Active <  6 and How_Many_Active > 1 then
		...
		--local message = "½ñÌìµÄÂÒ¶·ÖÐ¹²´æ»îÁË"..How_Many_Active .."Î»Íæ¼Ò,ËûÃÇÃ¿ÈË½«»ñµÃ"..Money_Garner2 .."µÄ½ðÇ®ºÍ1¸öÂÒ¶·Ö®ÐÇ»ÕÕÂ"
		--Notice ( message )
		return
	end
	...
	if How_Many_Active == 1 then
		...
		local message = "Grettings "..cha_name.." obtained ".. Money_Garner2 .." gold and 1 King of Ring Emblem"
	--	SystemNotice(role,How_Many_Active)
...
function CheckTeamers( role )
	local Team_In = IsInTeam(role)
	if Team_In == 1 then
	local characterName = GetChaDefaultName(role)
	Notice ( role , characterName.." is a blatant cheater teaming in CA." )
	end
end
